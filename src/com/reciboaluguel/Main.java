...
import com.reciboaluguel.excecao.ExcecaoRecibo;
...
public class Main {
	...
	public void lerArquivo() throws ExcecaoRecibo {
		try {
			File fill = new File("c://recibo.txt");
		} catch (FileNotFoundException e) {
			throw new ExcecaoRecibo("Erro ao gerar recibo: " + e.getMessage());
		}
	}
}
